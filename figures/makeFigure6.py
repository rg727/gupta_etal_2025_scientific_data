# -*- coding: utf-8 -*-
"""
Created on Fri Aug 29 12:09:38 2025
...
# -*- coding: utf-8 -*-
"""
Created on Wed Jul 30 12:09:28 2025
...
KGE_train_clim_1995_2013=pd.read_csv("C:/Users/rg727/Documents/Great Lake Project/Paper/Figures/Box_Plots_Training/Metrics/Training/KGE/KGE_train_clim_1995_2013.csv")



diff_df = pd.DataFrame(KGE_train_nn_1995_2013['ID'])
diff_df['KGE_diff'] = KGE_train_nn_1995_2013['KGE'] - KGE_train_clim_1995_2013['KGE']
...
plt.tight_layout()
plt.savefig("C:/Users/rg727/Documents/Great Lake Project/Paper/Figures/spatial_figures/KGE_diff_nnclim_train_new.pdf")
...
KGE_val_clim_1995_2013=pd.read_csv("C:/Users/rg727/Documents/Great Lake Project/Paper/Figures/LSTM_Comparison_Box_Plots/Data/1995_2013/KGE_val_clim_1995_2013.csv")


diff_df = pd.DataFrame(KGE_val_nn_1995_2013['ID'])
diff_df['KGE_diff'] = KGE_val_nn_1995_2013['KGE'] - KGE_val_clim_1995_2013['KGE']
...
#regulated median
val_reg_mean=np.nanmedian(regulated['KGE_diff'])
#natural 
val_natural_mean=np.nanmedian(natural['KGE_diff'])
...
cbar.ax.tick_params(labelsize=20)
plt.tight_layout()
plt.savefig("C:/Users/rg727/Documents/Great Lake Project/Paper/Figures/spatial_figures/KGE_diff_nnclim_val_new.pdf")
...
df = pd.DataFrame({'lab':['Natural', 'Regulated'], 'val':[0.07,0.04]})
...
ax.legend_.remove()
plt.savefig("C:/Users/rg727/Documents/Great Lake Project/Paper/Figures/spatial_figures/KGE_diff_train_barplot_nnclim.pdf")

df = pd.DataFrame({'lab':['Natural', 'Regulated'], 'val':[0.004,0.01]})
ax = df.plot.bar(x='lab', y='val', rot=0,color=colors)
ax.tick_params(axis='both', which='major', labelsize=30)
plt.tight_layout()
ax.spines['top'].set_visible(False)
ax.spines['right'].set_visible(False)
ax.legend_.remove()
plt.savefig("C:/Users/rg727/Documents/Great Lake Project/Paper/Figures/spatial_figures/KGE_diff_val_barplot_nnclim.pdf")



###################################################################PBIAS#############################################################

PBIAS_train_nn_1995_2013=pd.read_csv("C:/Users/rg727/Documents/Great Lake Project/Paper/Figures/Box_Plots_Training/Metrics/Training/PBIAS/PBIAS_train_nn_1995_2013.csv")
PBIAS_train_clim_1995_2013=pd.read_csv("C:/Users/rg727/Documents/Great Lake Project/Paper/Figures/Box_Plots_Training/Metrics/Training/PBIAS/PBIAS_train_clim_1995_2013.csv")



diff_df = pd.DataFrame(PBIAS_train_nn_1995_2013['ID'])
diff_df['PBIAS_diff'] = abs(PBIAS_train_clim_1995_2013['PBIAS']) - abs(PBIAS_train_nn_1995_2013['PBIAS'])
...
#regulated median
training_reg_mean=np.nanmedian(regulated['PBIAS_diff'])
#natural 
traning_natural_mean=np.nanmedian(natural['PBIAS_diff'])
# Plot
fig, ax = plt.subplots(figsize=(15, 10))
sixdomains.plot(ax=ax, edgecolor='gray', facecolor='lightgray')
lakes.plot(ax=ax, edgecolor='black', facecolor='lightblue')
...
#cbar.set_label('PBIAS_diff', weight='bold', fontsize=14)
cbar.ax.tick_params(labelsize=20)
plt.tight_layout()
plt.savefig("C:/Users/rg727/Documents/Great Lake Project/Paper/Figures/spatial_figures/PBIAS_diff_nnclim_train_new.pdf")

##############################################################################################################################


PBIAS_val_nn_1995_2013=pd.read_csv("C:/Users/rg727/Documents/Great Lake Project/Paper/Figures/LSTM_Comparison_Box_Plots/Metrics/Bias/BIAS_val_nn_1995_2013.csv")
PBIAS_val_clim_1995_2013=pd.read_csv("C:/Users/rg727/Documents/Great Lake Project/Paper/Figures/LSTM_Comparison_Box_Plots/Metrics/Bias/BIAS_val_clim_1995_2013.csv")


diff_df = pd.DataFrame(PBIAS_val_nn_1995_2013['ID'])
diff_df['PBIAS_diff'] = abs(PBIAS_val_clim_1995_2013['BIAS']) - abs(PBIAS_val_nn_1995_2013['BIAS'])
...
#regulated median
val_reg_mean=np.nanmedian(regulated['PBIAS_diff'])
#natural 
val_natural_mean=np.nanmedian(natural['PBIAS_diff'])
...
cbar.ax.tick_params(labelsize=20)
plt.tight_layout()
plt.savefig("C:/Users/rg727/Documents/Great Lake Project/Paper/Figures/spatial_figures/PBIAS_diff_nnclim_val_new.pdf")
...
df = pd.DataFrame({'lab':['Natural', 'Regulated'], 'val':[6.57,2.21]})
ax = df.plot.bar(x='lab', y='val', rot=0,color=colors)
ax.tick_params(axis='both', which='major', labelsize=30)
plt.tight_layout()
ax.spines['top'].set_visible(False)
ax.spines['right'].set_visible(False)
ax.legend_.remove()
plt.savefig("C:/Users/rg727/Documents/Great Lake Project/Paper/Figures/spatial_figures/PBIAS_diff_train_barplot_nnclim.pdf")

df = pd.DataFrame({'lab':['Natural', 'Regulated'], 'val':[-0.61,-0.57]})
ax = df.plot.bar(x='lab', y='val', rot=0,color=colors)
ax.tick_params(axis='both', which='major', labelsize=30)
plt.tight_layout()
ax.spines['top'].set_visible(False)
ax.spines['right'].set_visible(False)
ax.legend_.remove()
plt.savefig("C:/Users/rg727/Documents/Great Lake Project/Paper/Figures/spatial_figures/PBIAS_diff_val_barplot_nnclim.pdf")
...
# -*- coding: utf-8 -*-
"""
Created on Fri Aug 29 12:47:04 2025
...
diff_df['HBIAS_diff'] = abs(HBIAS_train_clim_1995_2013['HBIAS']) - abs(HBIAS_train_nn_1995_2013['HBIAS'])
...
cbar.ax.tick_params(labelsize=20)
plt.tight_layout()
plt.savefig("C:/Users/rg727/Documents/Great Lake Project/Paper/Figures/spatial_figures/HBIAS_diff_nnclim_train_new.pdf")
...
HBIAS_val_clim_1995_2013=pd.read_csv("C:/Users/rg727/Documents/Great Lake Project/Paper/Figures/LSTM_Comparison_Box_Plots/Metrics/HBIAS/HBIAS_val_clim_1995_2013.csv")


diff_df = pd.DataFrame(HBIAS_val_nn_1995_2013['ID'])
diff_df['HBIAS_diff'] = abs(HBIAS_val_clim_1995_2013['HBIAS']) - abs(HBIAS_val_nn_1995_2013['HBIAS'])
...
#regulated median
val_reg_mean=np.nanmedian(regulated['HBIAS_diff'])
#natural 
val_natural_mean=np.nanmedian(natural['HBIAS_diff'])
...
cbar.ax.tick_params(labelsize=20)
plt.tight_layout()
plt.savefig("C:/Users/rg727/Documents/Great Lake Project/Paper/Figures/spatial_figures/HBIAS_diff_nnclim_val_new.pdf")
...
df = pd.DataFrame({'lab':['Natural', 'Regulated'], 'val':[5.46,2.13]})
ax = df.plot.bar(x='lab', y='val', rot=0,color=colors)
ax.tick_params(axis='both', which='major', labelsize=30)
ax.spines['top'].set_visible(False)
ax.spines['right'].set_visible(False)
ax.legend_.remove()
ax.set_ylim(-1, 6)  # Set y-axis limits on the 'ax' object
plt.tight_layout()
plt.savefig("C:/Users/rg727/Documents/Great Lake Project/Paper/Figures/spatial_figures/HBIAS_diff_train_barplot_nnclim.pdf")

df = pd.DataFrame({'lab':['Natural', 'Regulated'], 'val':[0.09,-0.29]})
ax = df.plot.bar(x='lab', y='val', rot=0,color=colors)
ax.tick_params(axis='both', which='major', labelsize=30)
#plt.tight_layout()
ax.spines['top'].set_visible(False)
...
plt.savefig("C:/Users/rg727/Documents/Great Lake Project/Paper/Figures/spatial_figures/HBIAS_diff_val_barplot_nnclim.pdf")
...
LBIAS_train_clim_1995_2013=pd.read_csv("C:/Users/rg727/Documents/Great Lake Project/Paper/Figures/Box_Plots_Training/Metrics/Training/LBIAS/LBIAS_train_clim_1995_2013.csv")



diff_df = pd.DataFrame(LBIAS_train_nn_1995_2013['ID'])
diff_df['LBIAS_diff'] = abs(LBIAS_train_clim_1995_2013['LBIAS']) - abs(LBIAS_train_nn_1995_2013['LBIAS'])
...
cbar.ax.tick_params(labelsize=20)
plt.tight_layout()
plt.savefig("C:/Users/rg727/Documents/Great Lake Project/Paper/Figures/spatial_figures/LBIAS_diff_nnclim_train_new.pdf")
...
LBIAS_val_clim_1995_2013=pd.read_csv("C:/Users/rg727/Documents/Great Lake Project/Paper/Figures/LSTM_Comparison_Box_Plots/Metrics/LBIAS/LBIAS_val_clim_1995_2013.csv")


diff_df = pd.DataFrame(LBIAS_val_nn_1995_2013['ID'])
diff_df['LBIAS_diff'] = abs(LBIAS_val_clim_1995_2013['LBIAS']) - abs(LBIAS_val_nn_1995_2013['LBIAS'])
...
#regulated median
val_reg_mean=np.nanmedian(regulated['LBIAS_diff'])
#natural 
val_natural_mean=np.nanmedian(natural['LBIAS_diff'])
...
cbar.ax.tick_params(labelsize=20)
plt.tight_layout()
plt.savefig("C:/Users/rg727/Documents/Great Lake Project/Paper/Figures/spatial_figures/LBIAS_diff_nnclim_val_new.pdf")
...
df = pd.DataFrame({'lab':['Natural', 'Regulated'], 'val':[1.147,1.65]})
ax = df.plot.bar(x='lab', y='val', rot=0,color=colors)
ax.tick_params(axis='both', which='major', labelsize=30)
...
ax.set_ylim(-1,6)  # Set y-axis limits on the 'ax' object
plt.tight_layout()
plt.savefig("C:/Users/rg727/Documents/Great Lake Project/Paper/Figures/spatial_figures/LBIAS_diff_train_barplot_nnclim.pdf")

df = pd.DataFrame({'lab':['Natural', 'Regulated'], 'val':[0.03,-1.31]})
ax = df.plot.bar(x='lab', y='val', rot=0,color=colors)
ax.tick_params(axis='both', which='major', labelsize=30)
ax.spines['top'].set_visible(False)
ax.spines['right'].set_visible(False)
...
ax.set_ylim(-1,6)  # Set y-axis limits on the 'ax' object
plt.tight_layout()
plt.savefig("C:/Users/rg727/Documents/Great Lake Project/Paper/Figures/spatial_figures/LBIAS_diff_val_barplot_nnclim.pdf")
