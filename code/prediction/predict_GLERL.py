# -*- coding: utf-8 -*-
"""
Created on Tue Jul  8 10:34:17 2025
...
for seed in seed_all:
    folder_name = f"/scratch/bcqp/rg727/1950_1965_Training_Testing/GLERL_Predictions_NN/seed_{seed}"
...
basin_list_valid = np.loadtxt('/scratch/bcqp/rg727/basins_GLERL.txt',dtype=str)
...
for k, basin_id in enumerate(basin_list_valid):
    xy = np.loadtxt('/scratch/bcqp/rg727/1950_1965_GLERL_NN/'+basin_id+'.csv',delimiter=",", dtype=np.float32, skiprows=1)
    y = xy[:,[3]]
...
for k, basin_id in enumerate(basin_list_valid):
    ...
    with torch.no_grad():
        ...
        np.savetxt('/scratch/bcqp/rg727/1950_1965_Training_Testing/GLERL_Predictions_NN/seed_'+str(seed)+'/'+basin_id+'.csv', pred_obs, delimiter=',',header='pred,obs',comments='')
