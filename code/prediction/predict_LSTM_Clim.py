# -*- coding: utf-8 -*-
"""
Created on Fri May 16 11:35:33 2025
...
basin_list_valid = np.loadtxt('/scratch/bcqp/rg727/1950_1965_Training_Testing/fold_5_calibration.txt', dtype=str) 
n_day = ((l_date-f_date).days+1)-squence_length+1
...
for k, basin_id in enumerate(basin_list_valid):
    ...
    with torch.no_grad():
        ...
        np.savetxt('/scratch/bcqp/rg727/1950_1965_Training_Testing/Training/fold_5/prediction/lstm_nbr_pred_'+basin_id+'.csv', pred_obs, delimiter=',',header='pred,obs',comments='')
   ...
   # np.savetxt('/scratch/bcqp/rg727/1950_1965_Training_Testing/Testing/out_1/OOS/nse_validation_cv_check.csv', nse_valid, delimiter=',',header='test',comments='')
